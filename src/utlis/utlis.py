...
def model_evaluate(X_train, y_train, X_test, y_test, models):
    try:
        ...
        for model_name, model in models.items():
            ...
            test_model_precision = precision_score(y_test, y_pred,average='macro')

            # Store the accuracy in the report dictionary
            report[model_name] = test_model_precision
...
symptoms_dict = {k.lower(): v for k, v in symptoms_dict.items()}
